...
class Split(enum.Enum):
  ...
  def num_examples(self):
    return {Split.TRAIN_AND_VALID: 9469, Split.TRAIN: 8000,
            Split.VALID: 469, Split.TEST: 1000}[self]
...
def load(
  ...
  start, end = _shard(split, jax.host_id(), jax.host_count()) #jax.host_id has been renamed to jax.process_index. This alias will eventually be removed;
  ...
  ds = tfds.load('imagenette/320px-v2', split=tfds_split,
